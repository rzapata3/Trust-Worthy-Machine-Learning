...
def perturb_image(xs, img):
    ...
    for x, img in zip(xs, imgs):
        ...
        for pixel in pixels:
            ...
            pos, *rgb = pixel
            imgGray = 0.2989 * rgb[0] + 0.5870 * rgb[1] + 0.1140 * rgb[2]
...
def checkpoint(results, targeted=False):
    ...
    with open('C:/Users/HP/PycharmProjects/FinalProject/Trust-Worthy-Machine-Learning/' + filename + '_results.pkl', 'wb') as file:
